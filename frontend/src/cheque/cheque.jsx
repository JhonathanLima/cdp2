...
import {create, update, remove} from './chequeActions'

import List from './chequeList'
import Form from './chequeForm'
...
class Cheque extends Component {
    ...
    render(){
        return(
            <div> 
                <ContentHeader title= 'Cheques' small='Controle'/>
                <Content>
                    <Tabs>
                        <TabsHeader>
...
export default connect(null, mapDispatchToProps)(Cheque)